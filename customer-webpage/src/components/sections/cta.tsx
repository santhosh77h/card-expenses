...
const reviews = [
  {
    name: "Priya",
    username: "@priya",
    body: "Vector Expense has completely changed how I track my expenses. Upload and done!",
    img: "https://avatar.vercel.sh/priya",
  },
  {
    name: "James",
    username: "@james",
    body: "The privacy-first approach is exactly what finance apps should be.",
    img: "https://avatar.vercel.sh/james",
  },
  {
    name: "Ananya",
    username: "@ananya",
    body: "Managing 4 credit cards used to be a nightmare. Not anymore.",
    img: "https://avatar.vercel.sh/ananya",
  },
  {
    name: "David",
    username: "@david",
    body: "3 models voting on each transaction means near-perfect accuracy.",
    img: "https://avatar.vercel.sh/david",
  },
  {
    name: "Sarah",
    username: "@sarah",
    body: "Multi-currency support is perfect for my travel expenses.",
    img: "https://avatar.vercel.sh/sarah",
  },
  {
    name: "Rahul",
    username: "@rahul",
    body: "CSV export saves me hours during tax season. Incredible.",
