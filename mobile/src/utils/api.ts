...
const categoryKeywords: { category: string; icon: string; keywords: string[] }[] = [
  { category: 'Food & Dining', icon: 'fork-knife', keywords: ['swiggy', 'zomato', 'restaurant', 'cafe', 'starbucks', 'pizza', 'burger', 'food', 'dining', 'dominos', 'mcdonalds', 'kfc', 'biryani', 'dinner', 'lunch', 'breakfast'] },
  { category: 'Groceries', icon: 'shopping-cart', keywords: ['bigbasket', 'blinkit', 'grofers', 'dmart', 'grocery', 'supermarket', 'zepto', 'dunzo', 'instamart', 'vegetables', 'fruits'] },
  { category: 'Shopping', icon: 'shopping-bag', keywords: ['amazon', 'flipkart', 'myntra', 'ajio', 'nykaa', 'meesho', 'shopping', 'mall', 'store', 'retail', 'fashion'] },
  { category: 'Transportation', icon: 'car', keywords: ['uber', 'ola', 'rapido', 'metro', 'petrol', 'diesel', 'fuel', 'parking', 'toll', 'indian oil', 'hp petrol', 'bharat petroleum'] },
  { category: 'Entertainment', icon: 'film', keywords: ['netflix', 'spotify', 'hotstar', 'prime video', 'youtube', 'cinema', 'movie', 'concert', 'gaming', 'playstation', 'xbox', 'bookmyshow'] },
  { category: 'Health & Medical', icon: 'heart-pulse', keywords: ['apollo', 'pharmacy', 'hospital', 'doctor', 'medical', 'health', 'gym', 'cult.fit', 'fitness', 'lab', 'diagnostic', 'medicine'] },
  { category: 'Utilities & Bills', icon: 'zap', keywords: ['jio', 'airtel', 'vodafone', 'electricity', 'water', 'gas', 'broadband', 'wifi', 'recharge', 'bill', 'bescom', 'bsnl', 'fiber'] },
  { category: 'Travel', icon: 'plane', keywords: ['makemytrip', 'goibibo', 'indigo', 'air india', 'spicejet', 'hotel', 'booking', 'flight', 'train', 'irctc', 'oyo', 'airbnb'] },
  { category: 'Education', icon: 'book-open', keywords: ['udemy', 'coursera', 'kindle', 'book', 'school', 'college', 'tuition', 'course', 'unacademy', 'byjus', 'education'] },
  { category: 'Finance & Investment', icon: 'trending-up', keywords: ['groww', 'zerodha', 'mutual fund', 'sip', 'investment', 'insurance', 'lic', 'premium', 'brokerage', 'trading'] },
  { category: 'Transfers', icon: 'repeat', keywords: ['transfer', 'neft', 'imps', 'upi', 'google pay', 'phonepe', 'paytm', 'bhim', 'gpay'] },
];
